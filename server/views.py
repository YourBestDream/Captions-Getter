...
@app.route(f'/results/stats', methods=['GET'])
def statistics(): #video_id потом добавишь
    # local = False
    ...
    # llm = OpenAI(model_name="gpt-3.5-turbo", openai_api_key="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")
